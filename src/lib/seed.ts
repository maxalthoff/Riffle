...
const seeds = [
  ...
  { title: 'Back to the Future Part II', category: 'Movie', status: 'Want to Consume', daysAgo: 1, year: 1989, creator: 'Robert Zemeckis', genre: 'Adventure', details: { runtime: 108, language: 'English', country: 'USA' } },
  ...
  { title: 'The Art of War', category: 'Book', status: 'Completed', daysAgo: 90, year: -500, creator: 'Sun Tzu', genre: 'Philosophy', details: { pages: 68, language: 'English', format: 'Paperback' }, dateStarted: '2026-01-15', dateCompleted: '2026-01-20' },
  ...
  { title: 'The Crown', category: 'Show', status: 'Want to Consume', daysAgo: 3, year: 2016, creator: 'Peter Morgan', genre: 'Drama', details: { seasons: 6, network: 'Netflix', status: 'Finished' } },
  { title: 'Better Call Saul', category: 'Show', status: 'Completed', daysAgo: 55, year: 2015, creator: 'Vince Gilligan & Peter Gould', genre: 'Drama', details: { seasons: 6, network: 'AMC', status: 'Finished' }, dateStarted: '2026-03-01', dateCompleted: '2026-03-30' },
  { title: 'Breaking Bad', category: 'Show', status: 'Completed', daysAgo: 80, year: 2008, creator: 'Vince Gilligan', genre: 'Drama', details: { seasons: 5, network: 'AMC', status: 'Finished' }, dateStarted: '2026-01-20', dateCompleted: '2026-02-28' },
  ...
  { title: 'The Last of Us', category: 'Game', status: 'Completed', daysAgo: 30, year: 2013, creator: 'Naughty Dog', genre: 'Action-Adventure', details: { platform: 'PS3', publisher: 'Sony' }, dateStarted: '2026-03-15', dateCompleted: '2026-03-25' },
  ...
  { title: 'Hollow Knight', category: 'Game', status: 'Want to Consume', daysAgo: 1, year: 2017, creator: 'Team Cherry', genre: 'Metroidvania', details: { platform: 'Switch', publisher: 'Team Cherry' } },
  ...
  { title: 'The Daily', category: 'Podcast', status: 'Want to Consume', daysAgo: 1, creator: 'Michael Barbaro', genre: 'News', details: { episodes: 5000, frequency: 'Daily', website: 'https://nytimes.com/thedaily' } },
  { title: 'Radiolab', category: 'Podcast', status: 'Completed', daysAgo: 85, creator: 'Jad Abumrad & Robert Krulwich', genre: 'Science', details: { episodes: 200, frequency: 'Weekly', website: 'https://radiolab.org' }, dateStarted: '2026-01-10', dateCompleted: '2026-02-15' },
  { title: '99% Invisible', category: 'Podcast', status: 'Dropped', daysAgo: 75, creator: 'Roman Mars', genre: 'Design', details: { episodes: 600, frequency: 'Weekly', website: 'https://99percentinvisible.org' } },
];
